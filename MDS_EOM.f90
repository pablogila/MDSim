! MDS_EOM.f90  v2023.02.28  by Pablo Gila-Herranz
!
...
!
! DEPENDENCIES: BEFORE USING THIS PROGRAM, COMPILE tipos.f90, MDS_init.f90
! WITH THE SAME VALUES OF Nx, Ny and Nz
!
! The MDS_init.f90 gives us all the initial info.
...
! WARNING: This values MUST be the same of MDS_init.f90
